package net.mcreator.pruebatfg;
...
@Mod("pruebatfg")
public class PruebatfgMod {
	public static final Logger LOGGER = LogManager.getLogger(PruebatfgMod.class);
	public static final String MODID = "pruebatfg";

	public PruebatfgMod(IEventBus modEventBus) {
